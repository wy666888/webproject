...
public class FreemarkerUtil {
	...
	private static final Integer TEMPLATE_LOADING_CONTEXT = 0;
   ...
   /* static{
     ...
     * @throws Exception 
     */
    public static void initConfig(Integer type,String dir,HttpServletRequest request) throws Exception{
        /**
        ...
        /**
         * 设置模板本件夹路径：
         * 0、setServletContextForTemplateLoading,context
         * 1、setDirectoryForTemplateLoading，文件系统绝对路径
         * 2、setClassForTemplateLoading项目相对路径
         */
        if(TEMPLATE_LOADING_CONTEXT == type){
            freemarkerConfig.setServletContextForTemplateLoading(request.getSession().getServletContext(), dir);
        }
